...
import { FaUserPlus as InviteLinkIcon, FaPhoneAlt as PhoneIcon, FaDoorOpen as LeaveIcon, FaDoorClosed as StartIcon, FaCog as SettingsIcon } from "react-icons/fa";
...
function RoomNavbar({ isMobileScreen, setScoreboardOpen }) {
      ...
      <nav className="p-4 flex justify-between">
        ...
        <div className="flex gap-2 items-center">
          <button className="text-center gap-3 w-12 h-12 p-3 bg-secondary font-semibold rounded-lg hover:cursor-pointer hover:bg-lightSecondary" onClick={() => setMobileChatOpen((prev) => !prev)}>
            <IoMdChatbubbles className="text-xl mx-auto" />
          </button>
          ...
          >
            <ScoreboardIcon className="text-xl mx-auto" />
          </button>
          <div className="open-modal relative">
            ...
            >
              <SettingsIcon className="text-xl mx-auto" />
            </button>
      ...
      <nav className="px-6 py-3 flex justify-between border-b border-grey3">
        ...
        <div className="flex gap-2 items-center">
          ...
          <button className="text-center gap-3 w-12 h-12 p-3 bg-secondary font-semibold rounded-lg hover:cursor-pointer hover:bg-lightSecondary" onClick={startVoiceCall}>
            <PhoneIcon className="text-xl mx-auto" />
          </button>
          ...
          <div className="relative">
            ...
            >
              <InviteLinkIcon className="text-xl mx-auto" />
            </button>
