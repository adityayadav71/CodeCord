    ...
    (isMobileScreen ? (
      ...
      <nav className="px-6 py-3 flex justify-between border-b border-grey3">
        ...
        <div className="flex gap-2 items-center">
          ...
          <button
            className="flex min-w-[126px] justify-center items-center gap-3 px-3 py-2 bg-accent1 font-semibold rounded-lg hover:cursor-pointer hover:bg-lightAccent1"
          ...
          <div className="relative">
            ...
            {inviteLinkModal && (
              <InviteLinkModal isMobileScreen={isMobileScreen} />
            )}
          </div>
        </div>
      </nav>
