    ...
    <div className="flex flex-col h-full">
      ...
      <div className="overflow-y-scroll px-3 pt-6">
        ...
        <div className="mb-6">
          ...
          possimus non ex molestiae ipsam laboriosam placeat exercitationem
          corporis omnis id incidunt hic modi, soluta animi nemo. Numquam eius
          fugiat cum.
        </div>
        <div className="mb-6">
          <h1 className="mb-6 font-bold">Example 1:</h1>
          <div className="px-3 py-2 rounded-lg bg-lightAccent3">
            <span className="font-bold">Input:</span> s = "abcabcbb" <br />{" "}
            <span className="font-bold">Output:</span> 3 <br />
            <span className="font-bold">Explanation:</span> The answer is "abc",
