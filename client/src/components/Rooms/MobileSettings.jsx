    ...
    <div className="modal absolute top-14 right-0 bg-secondary shadow-dropDown z-50 rounded-lg lg:h-fit lg:w-80 w-96 p-3">
      ...
      <div className="flex flex-col justify-center gap-3 mt-6">
        ...
        {roomData?.owner?._id === userData?._id &&
          (roomData?.startedAt ? (
            <button
              className="flex items-center gap-3 px-6 py-2 bg-hardRed font-semibold rounded-lg hover:cursor-pointer hover:bg-redBackGround"
            ...
            <button
              className="flex items-center gap-3 px-6 py-2 bg-green-600 font-semibold rounded-lg hover:cursor-pointer hover:bg-easyGreen"
        ...
        <button
          className="flex items-center gap-3 px-6 py-2 bg-accent1 font-semibold rounded-lg hover:cursor-pointer hover:bg-lightAccent1"
