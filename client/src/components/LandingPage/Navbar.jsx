  ...
  return (
    <nav className="flex flex-row items-center py-11 px-9">
      ...
      <div className="flex flex-row items-center gap-x-6 ml-auto">
        ...
        <button className="p-3 w-36 text-xl transition-all ease-in-out duration-300 hover:cursor-pointer hover:scale-110 bg-accent1 text-white font-bold rounded-xl hover:shadow-feature1 hover:shadow">Sign up</button>
      </div>
    </nav>
  );
};
