  ...
  return (
    <nav className="flex flex-row items-center py-11 px-9 w-full">
      ...
      <div className="flex flex-row items-center gap-x-6 ml-auto">
        ...
        <Link to="/signup" className="p-3 w-36 text-xl transition-all ease-in-out duration-300 hover:cursor-pointer hover:scale-110 bg-accent1 text-white text-center font-bold rounded-xl hover:shadow-signUp hover:shadow">Sign up</Link>
      </div>
    </nav>
  );
};
