...
const Hero = (props) => {
  return (
    <div className="px-9 mt-11 mb-11 h-screen max-h-[720px]">
      ...
      <div className="absolute z-[-1] bg-graphicLightBlue w-[1801.5px] h-[1273.94px] -top-[41.677%] left-[69.677%] origin-center -rotate-[42deg]"></div>
      <div className="absolute z-[-1] bg-graphicDarkBlue w-[472.59px] h-[545.4px] top-[45%] left-[90%] origin-center -rotate-[42deg]"></div>
