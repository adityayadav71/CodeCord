...
const Tags = ({ isTagsActive, activeTags, setActiveTags, handleClick, addTag }) => {
  return (
    <div className="dropdown relative" data-value="Tags">
      ...
      <TagFilter activeTags={activeTags} setActiveTags={setActiveTags} isTagsActive={isTagsActive} />
    </div>
  );
};
