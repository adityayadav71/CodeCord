...
const Difficulty = ({ isDifficultyActive, handleClick, addTag }) => {
  return (
    <div className="dropdown relative" data-value="Difficulty">
      ...
      >
        <div className="hover:bg-accent3 mb-3 font-bold text-easyGreen rounded-lg px-3 py-1" value="Easy" onClick={addTag}>
          Easy
        </div>
        <div className="hover:bg-accent3 mb-3 font-bold text-mediumYellow rounded-lg px-3 py-1" value="Medium" onClick={addTag}>
          Medium
        </div>
        <div className="hover:bg-accent3 font-bold text-hardRed rounded-lg px-3 py-1" value="Hard" onClick={addTag}>
          Hard
        </div>
      </div>
    </div>
